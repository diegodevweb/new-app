...
<div class="flex flex-col justify-center items-center w-full max-w-5xl rounded-lg shadow-md p-6">
    <h1 class="mb-6 text-center text-4xl">Nova dúvida</h1>
    <form action="{{ route('supports.store') }}" method="POST">
        @csrf
        <div class="mb-4">
            <input type="text" placeholder="Assunto" name="subject" class="border rounded px-2 py-1 w-full">
        </div>
        <div class="mb-4">
            <textarea name="content" cols="30" rows="5" placeholder="Descrição" class="border rounded px-2 py-1 w-full"></textarea>
        </div>
        <div>
